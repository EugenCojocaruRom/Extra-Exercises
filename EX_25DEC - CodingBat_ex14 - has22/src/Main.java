...
public class Main {
    public static void main(String[] args) {
        ...
        readArrayA(A, sc);
        //Method for finding if there are 2 consecutive values of 2
        System.out.println("The array contains 2 consecutive 2's: " + has22(A));
    }
    ...
    //Define the method for finding if there are 2 consecutive values of 2
    static boolean has22(int[] A) {
        //Loop through array A from i = 0 to the length of A, incrementing i by 1
        for (int i = 0; i < A.length; i++) {
            //Set the condition for checking if there are 2 consecutive 2's
            if (A[i] == 2 && A[i + 1] == 2) {
