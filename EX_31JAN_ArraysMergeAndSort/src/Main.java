...
public class Main {
    ...
    static String[] merge(String[] arr1, String[] arr2) {
        ...
        //Sort the elements of array3 using the Comparator class
        Arrays.sort(arr3, new Comparator<String>() {
            @Override
            //Use compare() method for comparing the elements of the merged array, to sort them in the correct order
            public int compare(String o1, String o2) {
                //Return the result of the comparison between 2 elements of the array
